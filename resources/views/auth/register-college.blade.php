<x-layout>
    ...
    <div class="w-full h-full px-16 pt-16 pb-32 flex justify-center items-center relative z-10">
        ...
        <div class="flex flex-col justify-center items-end">
            ...
            {{-- form --}}
            <form action="{{ route('registerCollegeStudent') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="mb-6">
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm font-medium text-primary-color underline">College Registration</span>
                            </div>
