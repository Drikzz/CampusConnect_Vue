<x-layout>
    ...
    <div class="w-full h-full px-16 pt-16 pb-32 flex justify-center items-center relative z-10">
        ...
        <div class="flex flex-col justify-center items-end">
            ...
            {{-- Progress indicator --}}
            @include('auth.partials.progress-indicator', ['currentStep' => 2, 'showSellerStep' => true])

            {{-- Registration form --}}
            <form id="collegeRegistrationForm" action="{{ route('registerCollegeStudent') }}" method="POST"
                ...
                <div class="w-[40rem] h-auto bg-slate-100 p-10 rounded-sm">
                    ...
                    <div class="mb-6">
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex items-center gap-2">
                                <span
                                    class="flex items-center justify-center w-5 h-5 text-xs border border-primary-color bg-primary-color text-white rounded-full">1</span>
                            ...
                            <!-- Arrow -->
                            <svg class="w-3 h-3 text-primary-color" aria-hidden="true"
                            ...
                            <div class="flex items-center gap-2">
                                <span
                                    class="flex items-center justify-center w-5 h-5 text-xs border border-primary-color bg-primary-color text-white rounded-full">2</span>
                                <span class="text-sm font-medium text-primary-color underline">College
                                    Registration</span>
                            </div>
                            ...
                            <div class="flex items-center gap-2">
                                <span
                                    class="flex items-center justify-center w-5 h-5 text-xs border border-primary-color bg-primary-color text-white rounded-full">3</span>
                    ...
                    <div class="grid grid-cols-2 gap-9 mb-6">
                            ...
                            <div class="relative">
                                ...
                                <div>
                                    <div class="relative mb-1">
                                        <div
                                            class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                                            <svg class="w-4 h-4 fill-primary-color " id="Layer_1" height="512"
                                        ...
                                        <input type="text" id="first_name" name="first_name"
                                            class="bg-gray-50 border border-primary-color text-black placeholder:text-gray-400 text-sm rounded-lg focus:ring-primary-color focus:ring focus:outline-none focus:transition-all block w-full ps-10 p-2.5 @error('first_name') ring-red-500 @enderror"
                                ...
                                <div>
                                    <div class="relative mb-1">
                                        ...
                                        <input type="text" id="last_name" name="last_name"
                                            class="bg-gray-50 border border-primary-color text-black placeholder:text-gray-400 text-sm rounded-lg focus:ring-primary-color focus:ring focus:outline-none focus:transition-all block w-full ps-10 p-2.5 @error('last_name') ring-red-500 @enderror"
                        ...
                        <div class="w-full flex flex-col gap-4">
                                ...
                                <div>
                                    <div class="relative mb-1">
                                        ...
                                        <input type="text" id="wmsu_email" name="wmsu_email"
                                            ...
                                            placeholder="WMSU Email" value="{{ old('wmsu_email') }}">
                                    </div>
                            ...
                            <div class="relative">
                                <label for="wmsu_dept"
                                    class="block mb-2 text-sm font-medium text-black">College/Department:</label>
                                <div>
                                    <div class="relative mb-1">
                                        <div
                                            class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                                            <svg class="w-4 h-4 fill-primary-color" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 24 24">
                                                <path
                                                    d="M12,2L1,8l11,6l11-6L12,2z M12,15L3,10.4v4.8L12,21l9-5.8v-4.8L12,15z" />
                                            </svg>
                                        </div>
                                        <select id="wmsu_dept" name="wmsu_dept"
                                            class="bg-gray-50 border border-primary-color text-black text-sm rounded-lg focus:ring-primary-color focus:ring focus:outline-none focus:transition-all block w-full ps-10 p-2.5 @error('wmsu_dept') ring-red-500 @enderror">
                                            <option value="">-- Select Department --</option>
                                            @foreach ($departments as $department)
                                                <option value="{{ $department->code }}"
                                                    {{ old('wmsu_dept') == $department->code ? 'selected' : '' }}>
                            ...
                            <div class="w-full h-full flex flex-col">
                                <div class="h-full">
                                    ...
                                    <label for="profile_picture"
                                        class="block mb-2 text-sm font-medium text-black">Profile Picture:</label>

                                    {{-- Upload Container --}}
                                    <label for="profile_picture" id="uploadContainer"
                                        class="flex flex-col items-center justify-center w-full h-[calc(100%-2rem)] border-2 border-primary-color border-dashed rounded-lg bg-gray-50 hover:bg-gray-100 cursor-pointer">
                                    ...
                                    <div class="flex flex-col h-full gap-4">
                                        ...
                                        <div id="previewContainer"
                                            class="w-full h-52 border-2 border-primary-color border-dashed rounded-lg bg-gray-50 flex items-center justify-center {{ session('preview_image') ? 'flex' : 'hidden' }}">
                                            <img id="preview" class="h-full w-full object-cover" src=""
                                                alt="Preview">
                                        </div>
                                        {{-- Change Photo Button --}}
                                        <button id="changePhotoBtn"
                                            class="px-4 py-2 bg-primary-color text-white rounded-lg justify-center"
                                            type="button">
                                            Change Photo
                                        </button>
                                    </div>
                        ...
                        <div class="w-full h-full flex flex-col">
                            <div class="h-full">
                                {{-- Label for Profile Picture --}}
                                <label for="wmsu_id_front" class="block mb-2 text-sm font-medium text-black">WMSU ID
                                    (Front):</label>

                                {{-- Upload Container --}}
                                <label for="wmsu_id_front" id="uploadContainerFront"
                                    class="flex flex-col items-center justify-center w-full h-64 border-2 border-primary-color border-dashed rounded-lg bg-gray-50 hover:bg-gray-100 cursor-pointer">
                                    <svg class="w-8 h-8 mb-4 text-gray-500 dark:text-gray-400" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="2"
                                    ...
                                    <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span
                                            class="font-semibold">Click to upload</span> or drag and drop</p>
                                    <p class="text-xs text-gray-500 dark:text-gray-400">SVG, PNG, JPG or GIF (MAX SIZE
                                        2MB)</p>
                                ...
                                <div class="flex flex-col h-full gap-4">
                                    {{-- Preview Container --}}
                                    <div id="previewContainerFront"
                                        class="w-full h-64 border-2 border-primary-color border-dashed rounded-lg bg-gray-50 items-center justify-center hidden">
                                        <img id="previewFront" class="h-full w-full object-cover" src=""
                                            alt="Preview">
                                    </div>
                                    {{-- Change Photo Button --}}
                                    <button id="changePhotoBtnFront"
                                        class="px-4 py-2 bg-primary-color text-white rounded-lg justify-center"
                                        type="button">
                                        Change Photo
                                    </button>
                        ...
                        <div class="w-full h-full flex flex-col">
                            <div class="h-full">
                                {{-- Label for  --}}
                                <label for="wmsu_id_back" class="block mb-2 text-sm font-medium text-black">WMSU ID
                                    (Back):</label>

                                {{-- Upload Container --}}
                                <label for="wmsu_id_back" id="uploadContainerBack"
                                    class="flex flex-col items-center justify-center w-full h-64 border-2 border-primary-color border-dashed rounded-lg bg-gray-50 hover:bg-gray-100 cursor-pointer">
                                    <svg class="w-8 h-8 mb-4 text-gray-500 dark:text-gray-400" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <div class="flex flex-col h-full gap-4">
                                    {{-- Preview Container --}}
                                    <div id="previewContainerBack"
                                        class="w-full h-64 border-2 border-primary-color border-dashed rounded-lg bg-gray-50 items-center justify-center hidden">
                                        <img id="previewBack" class="h-full w-full object-cover" src=""
                                            alt="Preview">
                                    </div>
                                    {{-- Change Photo Button --}}
                                    <button id="changePhotoBtnBack"
                                        class="px-4 py-2 bg-primary-color text-white rounded-lg justify-center"
                                        type="button">
                                        Change Photo
                                    </button>
                    ...
                    <div class="flex justify-between mt-6">
                        <button type="button" class="px-4 py-2 text-primary-color"
                            onclick="window.history.back()">Back</button>
                        <button type="submit" class="px-4 py-2 bg-primary-color text-white rounded-lg">Next</button>
                    </div>
