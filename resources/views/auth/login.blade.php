                        ...
                        <div class="relative">
                            ...
                            <div class="relative mb-6">
                                <div class="relative mb-1">
                                    ...
                                    <input type="text" id="password" name="password" class="bg-gray-50 border border-primary-color text-black placeholder:text-gray-400 text-sm rounded-lg focus:ring-primary-color focus:ring focus:outline-none focus:transition-all block w-full ps-10 p-2.5 @error('password') ring-red-500 @enderror" placeholder="password123">
                                </div>
