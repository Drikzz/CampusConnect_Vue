<x-layout>
    ...
    <div class="w-full h-full px-16 pt-16 pb-32 flex justify-center items-center relative z-10">
        ...
        <div class="flex flex-col justify-center items-end">
            ...
            {{-- form --}}
            <form action="{{ route('register_postGraduate') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="w-[40rem] h-auto bg-slate-100 p-10 rounded-sm">
                    ...
                    <div class="mb-6">
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm font-medium text-primary-color underline">Post Graduate Registration</span>
                            </div>
                    ...
                    <div class="grid grid-cols-2 gap-9 mb-6">
                        ...
                        <div class="w-full flex flex-col gap-4">
                            ...
                            <div class="relative">
                                <label for="wmsu_dept" class="block mb-2 text-sm font-medium text-black">College/Department:</label>
                                <div>
                                    <div class="relative mb-1">
                                        <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                                        ...
                                        <select id="wmsu_dept" name="wmsu_dept" class="bg-gray-50 border border-primary-color text-black text-sm rounded-lg focus:ring-primary-color focus:ring focus:outline-none focus:transition-all block w-full ps-10 p-2.5 @error('wmsu_dept') ring-red-500 @enderror">
                                            <option value="">-- Select Department --</option>
                                            @foreach ($departments as $department)
                                                <option value="{{ $department->code }}" {{ old('wmsu_dept') == $department->code ? 'selected' : '' }}>{{ $department->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @error('wmsu_dept')
                            ...
                            <div class="w-full h-full flex flex-col">
                                <div class="h-full">
                                    ...
                                    <div class="flex flex-col h-full gap-4">
                                        {{-- Preview Container --}}
                                        <div id="previewContainer" class="w-full h-52 border-2 border-primary-color border-dashed rounded-lg bg-gray-50 flex items-center justify-center {{ session('preview_image') ? 'flex' : 'hidden' }}">
