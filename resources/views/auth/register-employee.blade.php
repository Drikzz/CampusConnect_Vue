    ...
    <div class="w-full h-full px-16 pt-16 pb-32 flex justify-center items-center relative z-10">
        ...
        <div class="flex flex-col justify-center items-end">
            ...
            <form action="{{ route('registerEmployee') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="w-fit h-auto bg-slate-100 p-10 rounded-sm">
                    ...
                    <div class="mb-6">
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm font-medium text-primary-color underline">Employee Registration</span>
                            </div>
                    ...
                    <div class="gap-9">
                        ...
                        <div class="w-full flex flex-col gap-4 mb-6">
                            ...
                            <div class="w-full h-full flex flex-col">
                                <div class="h-full">
                                    ...
                                    {{-- Upload Container --}}
                                    <label for="profile_picture" id="uploadContainer" class="flex flex-col items-center justify-center w-full h-64 border-2 border-primary-color border-dashed rounded-lg bg-gray-50 hover:bg-gray-100 cursor-pointer">
                                    ...
                                    <div class="flex flex-col h-full gap-4">
                                        {{-- Preview Container --}}
                                        <div id="previewContainer" class="w-full h-64 border-2 border-primary-color border-dashed rounded-lg bg-gray-50 flex items-center justify-center {{ session('preview_image') ? 'flex' : 'hidden' }}">
                        ...
                        {{-- <div class="w-full flex flex-col gap-4">
                                    ...
                                    <div class="relative mb-1">
                                        ...
                                        <select id="grade_level" name="grade_level" class="bg-gray-50 border border-primary-color text-black text-sm rounded-lg focus:ring-primary-color focus:ring focus:outline-none focus:transition-all block w-full ps-10 p-2.5 @error('grade_level') ring-red-500 @enderror">
                                            ...
                                            @foreach ($gradeLevels as $level)
                                                <option value="{{ $level->type }}" {{ old('grade_level') == $level->name ? 'selected' : '' }}>{{ $level->name ." ". $level->type }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @error('grade_level')
                            ...
                            picture id back
                            <div class="w-full h-full flex flex-col">
                                <div class="h-full"> <!-- Set explicit height -->
                                    <label for="profile_picture" class="block mb-2 text-sm font-medium text-black">Profile Picture:</label>
                                    
                                    <label for="profile_picture" class="flex flex-col items-center justify-center w-full h-[calc(100%-2rem)] border-2 border-primary-color border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                        ...
                        <div class="w-full flex flex-col">
                            <div class="h-64 mb-1"> <!-- Set explicit height -->
                                <label for="wmsu_id_front" class="block mb-2 text-sm font-medium text-black">WMSU ID Front:</label>
                                
                                <label for="wmsu_id_front" class="flex flex-col items-center justify-center w-full h-[calc(100%-2rem)] border-2 border-primary-color border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                                    <div class="flex flex-col items-center justify-center h-full w-full">
                                        <svg class="w-8 h-8 mb-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2"/>
                                        </svg>
                            ...
                            @error('wmsu_id_front')
                                <p class="text-red relative">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="w-full flex flex-col">
                            <div class="h-64 mb-1"> <!-- Set explicit height -->
                                ...
                                <label for="wmsu_id_back" class="flex flex-col items-center justify-center w-full h-[calc(100%-2rem)] border-2 border-primary-color border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                                    <div class="flex flex-col items-center justify-center h-full w-full">
                                        <svg class="w-8 h-8 mb-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2"/>
                                        </svg>
