    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-[30px] justify-center items-center">
        ...
        <div class="bg-white w-full h-[150px] rounded-[20px] shadow-lg p-[20px] flex items-center justify-between cursor-pointer transition-all ease-in-out hover:scale-105 hover:shadow-xl">
            <div class="text-black">
                ...
                <p class="text-[14px] text-[#a5a5a5]">Completed Transactions</p>
            </div>
            <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 text-gray-500" viewBox="0 0 24 24" width="48" height="48">
        ...
        <div class="bg-white w-full h-[150px] rounded-[20px] shadow-lg p-[20px] flex items-center justify-between cursor-pointer transition-all ease-in-out hover:scale-105 hover:shadow-xl">
            <div class="text-black">
                <h2 class="text-[28px] font-bold leading-[1.2]">0</h2>
                <p class="text-[14px] text-[#a5a5a5]">Cancelled/Failed</p>
            </div>
            <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="48" height="48"><path d="M12,0A12,12,0,1,0,24,12,12.013,12.013,0,0,0,12,0Zm0,2a9.949,9.949,0,0,1,6.324,2.262L4.262,18.324A9.992,9.992,0,0,1,12,2Zm0,20a9.949,9.949,0,0,1-6.324-2.262L19.738,5.676A9.992,9.992,0,0,1,12,22Z"/></svg>
        </div>
    </div>
                    ...
                    <div class="flex">
                        ...
                        <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdown-button">
                                ...
                                <li><button type="button" class="inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Cancelled</button></li>
