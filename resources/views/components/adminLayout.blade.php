...
<body class="bg-[#cad7fda4] max-w-full overflow-x-hidden">
    <!-- Header -->
    <header
        class="h-[70px] w-full px-[30px] bg-[#fafaff] fixed border-b-2 top-0 left-0 z-50 flex justify-between items-center">
        <div class="flex gap-[60px] items-center">
            ...
            <svg class="w-5 h-5 hover:scale-150 cursor-pointer transition-all duration-300" id="menuToggle"
        ...
        <form class="flex items-center max-w-sm mx-auto">
            ...
            <button type="submit"
                class="p-2.5 ms-2 text-sm font-medium text-white bg-red-700 rounded-lg border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
       ...
       <!-- Replace the existing profile div with this new one -->
       <div class="relative">
        <button id="profileButton" class="w-[40px] h-[40px] bg-[#626262] rounded-full flex items-center justify-center overflow-hidden">
            <img src="https://media.geeksforgeeks.org/wp-content/uploads/20221210180014/profile-removebg-preview.png"
                class="h-[42px]" alt="profile-image">
        </button>
    ...
    <div class="flex pt-[70px]">
        <!-- Sidebar -->
        <div id="sidebar"
            class="min-h-[91vh] w-[250px] bg-[#ffffff] shadow-md border-r-2 flex flex-col justify-between py-[30px] px-[10px] transition-all duration-300">
            <!-- Sidebar navigation -->
            <nav class="flex flex-col gap-[30px] items-center">
                <div class="flex flex-col gap-[30px]">
                    <!-- Dashboard link -->
                    <a href="{{ route('admin.dashboard') }}" 
                        class="flex items-center gap-4 px-5 py-4 hover:border-l-4 border-gray-400 transition-all">
                        <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24"
                            width="40" height="40" class="{{ request()->routeIs('admin.dashboard') ? 'text-red-600' : '' }} fill-current">
                        ...
                        <h3 class="text-lg {{ request()->routeIs('admin.dashboard') ? 'text-red-600' : '' }}">Dashboard</h3>
                    </a>

                    <!-- Sales link -->
                    <a href="{{ route('admin.sales') }}"
                        class="flex items-center gap-4 px-5 py-4 hover:border-l-4 border-gray-400 transition-all">
                        <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24"  width="40" height="40" class="{{ request()->routeIs('admin.sales') ? 'text-red-600' : '' }} fill-current">
                        ...
                        <h3 class="text-lg {{ request()->routeIs('admin.sales') ? 'text-red-600' : '' }}">Sales</h3>
                    </a>

                    <!-- Transactions link -->
                    <a href="{{ route('admin.transactions') }}"
                        class="flex items-center gap-4 px-5 py-4 hover:border-l-4 border-gray-400 transition-all">
                        <svg xmlns="http://www.w3.org/2000/svg" id="arrow-circle-down" viewBox="0 0 24 24"  width="40" height="40" class="{{ request()->routeIs('admin.transactions') ? 'text-red-600' : '' }} fill-current">
                            <path d="M0,7A1,1,0,0,1,1,6H18V2.639a.792.792,0,0,1,1.35-.552l4.418,4.361a.773.773,0,0,1,0,1.1L19.35,11.913A.792.792,0,0,1,18,11.361V8H1A1,1,0,0,1,0,7Zm23,9H6V12.639a.792.792,0,0,0-1.35-.552L.232,16.448a.773.773,0,0,0,0,1.1L4.65,21.913A.792.792,0,0,0,6,21.361V18H23a1,1,0,0,0,0-2Z"/></svg>
                        <h3 class="text-lg {{ request()->routeIs('admin.transactions') ? 'text-red-600' : '' }}">Transactions</h3>
                    </a>

                    <!-- Users link -->
                    <a href="{{ route('admin.users') }}"
                        class="flex items-center gap-4 px-5 py-4 hover:border-l-4 border-gray-400 transition-all">
                        <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="40" height="40"class="{{ request()->routeIs('admin.users') ? 'text-red-600' : '' }} fill-current">
                        ...
                        <h3 class="text-lg {{ request()->routeIs('admin.users') ? 'text-red-600' : '' }}">Users</h3>
                    </a>

                    <!-- Reports link -->
                    <a href="{{ route('admin.reports') }}"
                        class="flex items-center gap-4 px-5 py-4 hover:border-l-4 border-gray-400 transition-all">
                        <svg id="Layer_1" width="40" height="40"viewBox="0 0 24 24" width="512" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" class="{{ request()->routeIs('admin.reports') ? 'text-red-600' : '' }} fill-current">
                            <path d="m20 4h-5a4 4 0 0 0 -4-4h-7a4 4 0 0 0 -4 4v19a1 1 0 0 0 2 0v-10h8a4 4 0 0 0 4 4h6a4 4 0 0 0 4-4v-5a4 4 0 0 0 -4-4zm-18 7v-7a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v5a2 2 0 0 1 -2 2zm20 2a2 2 0 0 1 -2 2h-6a2 2 0 0 1 -2-2v-.142a4 4 0 0 0 3-3.858v-3h5a2 2 0 0 1 2 2z"/></svg>
                        <h3 class="text-lg {{ request()->routeIs('admin.reports') ? 'text-red-600' : '' }}">Reports</h3>
                    </a>

                    <!-- Products link -->
                    <a href="{{ route('admin.products') }}"
                        class="flex items-center gap-4 px-5 py-4 hover:border-l-4 border-gray-400 transition-all">
                        <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="40" height="40"  class="{{ request()->routeIs('admin.products') ? 'text-red-600' : '' }} fill-current">
                        ...
                        <h3 class="text-lg {{ request()->routeIs('admin.products') ? 'text-red-600' : '' }}">Products</h3>
                    </a>

                    <!-- Funds link -->
                    <a href="{{ route('admin.funds') }}"
                        class="flex items-center gap-4 px-5 py-4 hover:border-l-4 border-gray-400 transition-all">
                        <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="40" height="40" class="{{ request()->routeIs('admin.funds') ? 'text-red-600' : '' }} fill-current">
                        ...
                        <h3 class="text-lg {{ request()->routeIs('admin.funds') ? 'text-red-600' : '' }}">Funds</h3>
                    </a>
                </div>
            </nav>
        </div>
    ...
    <script>
        ...
        document.addEventListener('click', function(e) {
            if (!profileDropdown.contains(e.target) && isDropdownVisible) {
                profileDropdown.classList.add('hidden');
