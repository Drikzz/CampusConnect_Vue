    ...
    <header class="header-container">
        ...
        <nav class="flex justify-between items-center w-auto h-auto bg-primary-color px-16 py-6 sticky">
            ...
            <div class="flex justify-between items-center w-fit gap-4">
                ...
                <svg class="w-5 h-5 fill-white" xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="512" height="512">
...
{{-- modify this --}}
<!-- Dropdown menu -->
<div id="profileDropdown" class="hidden z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
    ...
    <div class="py-2">
        <form action="{{ route('logout') }}" method="POST">
            @csrf
            <button type="submit" class="block w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white text-left">
                Log out
            </button>
        </form>
    </div>
