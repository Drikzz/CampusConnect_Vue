<x-layout>
                    ...
                    <div>
                        ...
                        <div class="border-t border-gray-100 py-4 mb-6">
                            ...
                            <div class="flex items-center gap-3">
                                <img src="{{ Storage::url(auth()->user()->profile_picture) ?? 'default.jpg' }}"
                                    class="w-8 h-8 rounded-full object-cover">
                                <div>
                                    <p class="font-medium">{{ $product->user->name }}</p>
                                    <p class="text-sm text-gray-500">{{ $product->seller->location ?? 'Location N/A' }}
                                    </p>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Update form quantity when quantity changes
